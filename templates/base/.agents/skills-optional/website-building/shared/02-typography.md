...
For universal typography principles (Bringhurst foundations, economy of styles, display vs. body classification, serif vs. sans-serif strategy, brand fonts, font blacklist, and recommended pairings), see `.agents/skills-optional/using-design/design-foundations/SKILL.md`.
...
See `.agents/skills-optional/using-design/design-foundations/SKILL.md` → Font Strategy by Format for why websites differ from slides/documents.
