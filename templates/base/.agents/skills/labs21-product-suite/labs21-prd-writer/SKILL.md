...
description: Use when converting a validated blueprint, strategy, or OKR set into actionable Product Requirements Documents (PRDs), user stories, and acceptance criteria. Translates strategic constraints into engineering-ready scope.
---
...
Acknowledge the blueprint.
Verify the macro OKR.
State explicitly what is IN scope and what is OUT of scope for this PRD.
...
Produce the PRD using this exact markdown structure:
