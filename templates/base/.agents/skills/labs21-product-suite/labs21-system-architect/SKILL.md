...
description: Use when a validated PRD exists and engineering is about to begin. Translates PRDs into concrete technical architectures, database schemas, API contracts, state flows, and ADRs.
---
...
Translate human-readable requirements (the PRD) into machine-enforceable
contracts.
...
When invoked with a PRD or technical challenge, follow this exact sequence:
...
Produce the System Architecture document using this exact structure:
