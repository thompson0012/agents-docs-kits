...
3. The review decision is unambiguous: `PASS` or `FAIL`.
...
- `review.md` decides PASS vs FAIL.
...
- sprint id and title
- PASS or FAIL status
- concise summary of what changed or what failed
...
- do not mark PASS or FAIL into global state as final
