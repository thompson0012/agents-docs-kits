...
def scan(target: str | Path, repo_root: str | Path = ".") -> dict[str, Any]:
    """Main entry point. Returns scan results dict."""
    ...
    # Count blocking findings (P0-P2)
    blocking = [f for f in all_findings if f["severity"] in ("P0", "P1", "P2")]
    advisory = [f for f in all_findings if f["severity"] not in ("P0", "P1", "P2")]
