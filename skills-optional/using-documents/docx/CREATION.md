...
Pick a professional, universally installed sans-serif font as your base. Check `.agents/skills-optional/using-design/design-foundations/SKILL.md` for typeface recommendations. Keep heading text in black to ensure legibility.
