...
Download TTF files at runtime from Google Fonts, register with ReportLab, and they embed automatically. See `.agents/skills-optional/using-design/design-foundations/SKILL.md` for font pairings and rules.
...
**Fallback**: Helvetica (built-in, no download). **Blacklist**: see `.agents/skills-optional/using-design/design-foundations/SKILL.md` Font Rules.
