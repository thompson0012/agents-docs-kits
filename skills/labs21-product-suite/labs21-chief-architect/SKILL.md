...
description: Use when starting a new product from a raw idea, evaluating whether to pivot, stress-testing commercial viability and market fit, mapping blind spots, and producing the strategy / blueprint that defines the MVP and durable product intent.
---
...
**Primary output:** a strategy / blueprint document that becomes `docs/reference/design.md`.
This stage defines product intent, MVP boundary, and phased direction. It does not replace the downstream PRD or system-design stages.
...
Write the final strategy / blueprint to `docs/reference/design.md`. Keep implementation detail at blueprint level; the downstream PRD and system-design stages will make it executable.
...
One clear, specific next step (usually drafting `docs/reference/requirements.md`; otherwise pilot customer validation, pricing work, or another explicitly named prerequisite).
