...
- `labs21-product-suite` — staged product-definition router for blueprint -> requirements -> system design before defined-feature delivery begins

## Workflow Frameworks

- `harness-engineering` — front-door Anthropic-harness workflow pack for proposal -> contract -> execute -> evaluate -> compound without replacing the specialist delivery lanes
...
- `delivery-control` — family router for non-trivial feature delivery across harness design, contract approval, browser QA, and compounding
